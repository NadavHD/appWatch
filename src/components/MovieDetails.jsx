      ...
      {loading ? <span style={{ fontSize: "80px", alignItems: "center", display: "flex", justifyContent: "center", height: "100vh", color: "white" }}>Loading<BeatLoader style={{ fontSize: "80px" }} color="#ff0000" margin={5} size={10} speedMultiplier={1} /> </span> :
        <div className='container details_height'>
          <div className='d-md-flex' style={{ gap: "50px", paddingTop: "110px" }}>
            <div>
              {<img style={{ borderRadius: "10%", boxShadow: "10px 9px 20px 3px black", height: "500px" }} src={info.Poster} alt="" />}
            </div>
            <div className='movie_info text-white text-center' style={{ fontFamily: "sans-serif", fontSize: "20px",paddingTop:"80px" }}>
              <h1 style={{ fontWeight: "bold" }}>{info.Title}</h1>
              <p>{info.Plot}</p>
              <p style={{ fontWeight: "bold" }}>Genre:{info.Genre}</p>
